...
router.post(
  ...
  body('vendor.address').optional().isString(),
  body('vendor.taxId').optional().isString(),
  body('invoice.number').isString(),
  body('invoice.date').isString(),
  body('invoice.currency').optional().isString(),
  body('invoice.subtotal').optional().isNumeric(),
  body('invoice.taxPercent').optional().isNumeric(),
  body('invoice.total').optional().isNumeric(),
  body('invoice.poNumber').optional().isString(),
  body('invoice.poDate').optional().isString(),
  body('invoice.lineItems').isArray(),
...
router.put(
  ...
  body('vendor.name').optional().isString(),
  body('vendor.address').optional().isString(),
  body('vendor.taxId').optional().isString(),
  body('invoice.number').optional().isString(),
  body('invoice.date').optional().isString(),
  body('invoice.currency').optional().isString(),
  body('invoice.subtotal').optional().isNumeric(),
  body('invoice.taxPercent').optional().isNumeric(),
  body('invoice.total').optional().isNumeric(),
  body('invoice.poNumber').optional().isString(),
  body('invoice.poDate').optional().isString(),
  body('invoice.lineItems').optional().isArray(),
